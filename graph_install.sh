...
function important_information() {
 echo
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${GREEN}Windows Wallet Guide: ${PURPLE}https://github.com/g00tch/Graph/blob/master/README.md${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 ...
 echo -e "${GREEN}graphcoin-cli getinfo. ${CYAN} Compare the Blocks line with the explorer to ensure the VPS is synced${NC}"
 echo -e "${GREEN}graphcoin-cli masternode status${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
